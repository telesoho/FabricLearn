...
export FABRIC_CA_CLIENT_TLS_CERTFILES=$ROOT_TLS_CA_CERTFILES
...
export CORE_PEER_TLS_ROOTCERT_FILE=$ROOT_TLS_CA_CERTFILES
export CORE_PEER_LOCALMSPID=sdlMSP
export CORE_PEER_MSPCONFIGPATH=$FABRIC_CA_CLIENT_HOME/msp
export CORE_PEER_ADDRESS=peer1.sdl.localcoin.jp:8051
export FABRIC_CFG_PATH=$LOCAL_ROOT_PATH/config
export ORDERER=orderer0.orderer.localcoin.jp:7050
export CORE_PEER_GOSSIP_EXTERNALENDPOINT=peer1.sdl.localcoin.jp:8051
