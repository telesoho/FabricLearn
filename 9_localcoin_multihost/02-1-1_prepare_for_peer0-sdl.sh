...
fabric-ca-client enroll -d -u https://peer0-sdl:peer0-sdlpw@$CA_SDL_LOCALCOIN --csr.hosts peer0.sdl.localcoin.jp 2>&1 1>&log.txt
ifErrorPause
...
cp $FABRIC_CA_CLIENT_HOME/tls/tlscacerts/* $FABRIC_CA_CLIENT_HOME/msp/tlscacerts/ 2>&1 1>&log.txt
ifErrorPause "Failed to copy ..."
