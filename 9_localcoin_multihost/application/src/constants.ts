...
const FIXTURES_PATH = path.join(APP_PATH, 'ts-fixtures');
// const SCENARIO_PATH = path.join(TEST_PATH, 'ts-scenario');

export const CHAINCODE_PATH = path.join(FIXTURES_PATH, 'chaincode');
export const CONFIG_PATH = path.join(WORKING_PATH,'config');
export const TEMP_PATH = path.join(APP_PATH, 'temp');
...
export const COUCH_WALLET_URL = 'http://admin:adminpw@couchdb.localcoin.jp:5984';
...
// CLI paths
export const CLI_ORG1_PEER_ADDRESS = 'peer0.sdl.localcoin.jp:7051';
