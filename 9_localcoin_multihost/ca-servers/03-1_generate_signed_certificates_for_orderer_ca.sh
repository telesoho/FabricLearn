...
fabric-ca-client register -u https://$CA_TLS_LOCALCOIN --id.name ca-orderer-admin --id.secret ca-orderer-adminpw \
...
fabric-ca-client enroll -d -u https://ca-orderer-admin:ca-orderer-adminpw@$CA_TLS_LOCALCOIN \
